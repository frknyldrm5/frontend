...
console.log("***********");
 const aString= prompt("lütfen bir sayi giriniz");
...
console.log("aradiginiz string in indexi:", sayilar.indexOf(aString) );
bulunduMu=true;}

if(sayilar.includes(aNumber)){
console.log("aradiginiz number in indexi :" ,sayilar.indexOf(aNumber));
bulunduMu=true;}
